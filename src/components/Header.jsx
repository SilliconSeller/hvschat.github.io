...
=======
        <div className="w-full bg-zinc-50 shadow-md top-0 z-10 sticky border-b-[0.8px] border-slate-300">
...
=======
                    <div className="flex px-4 py-1.5  border-zinc-400 flex-row-reverse space-x-reverse space-x-3 items-center rounded-full bg-gray-100 hover:transform-gpu transition-all duration-200 hover:translate-x-3 hover:text-white hover:bg-zinc-700">
>>>>>>> refs/remotes/origin/main
