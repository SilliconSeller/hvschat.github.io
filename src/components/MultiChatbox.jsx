    ...
    return (
        ...
        <div className="flex h-full">
          ...
          <div className="flex-1 p-8 flex flex-col bg-white">
            <div className="flex flex-row justify-center space-x-3 px-3 py-2 bg-zinc-50 border-[2px] w-auto mx-16 drop-shadow-md rounded-lg border-red-400 hover:bg-zinc-100 hover:shadow-lg">
            <div className="text-sm font-mono text-zinc-800">
                ASSISTENTE PEDIDOS EM LISTA
            </div>
            <div>
              <img src={info} color='red' width={20} alt="" />
            </div>
            </div>
            ...
            <div className="pt-4 bg-white border-t border-gray-200">
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full px-4 py-4 pr-12 border rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-zinc-200"
                ...
                <button
                  onClick={sendMessage}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-zinc-50 border-[2px] border-red-400 text-zinc-800 py-2 px-4 rounded-lg shadow-md hover:bg-zinc-200 transition duration-300"
                >
                  Enviar
                </button>
              </div>
